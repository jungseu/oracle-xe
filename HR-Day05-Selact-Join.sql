...
조인(join)
    ...
    테이블은 조인하여 두 개 이상의 테이블에 있는 정보를 볼 수 있습니다
...
FROM employees JOIN department s
USING (department_id);
...
INNER JOIN과 OUTER JOIN 
    ...
    일치하지 않는 행은 출력애 표시 되지 않습니다
OUTER JOIN
    일치하지 않는 행도 반환 합니다
*/
/*
LEFT OUTER JOIN 
    DEPARTMENT 체이블에 대응되는 행이 없어도 
...
RIGHT OUTER JOIN
    ...
    오른쪽 테이블인 DEPARTMENT 테이블의 모든 행을 검색합니다
*/
...
/*
Cartesian product
    조인 조건이 잘못되거나 완전히 생략 된 경우 결과는 모든 행 조합이 표시되는 Cartesian product로 나타냅니다
*/
/*
Cross Join 생성
    Cross Join절은 두 테이블의 교차 곱을 생성합니다
*/
